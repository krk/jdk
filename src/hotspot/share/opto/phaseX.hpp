...
private:
  ...
  bool deep_revisit(uint& loop_count);
...
public:
...
#ifdef ASSERT
  void verify_optimize(bool deep, bool deep_revisit_converged);
  ...
  void verify_PhaseIterGVN(bool deep, bool deep_revisit_converged);
#endif
